...
class URNTest(unittest.TestCase):
    ...
    def testURN(self):
        ...
        self.assertEqual(rdfvalue.URN(url), url)
        # dont overload the constructor of URN to support a non-URN as an input
        # self.assertEqual(rdfvalue.URN("//etc/passwd"),
        #                  "file://etc/passwd")
    ...
    def testAppend(self):
        ...
        self.assertEqual(aff4volume.Append("index").SerializeToString(),
                          "aff4://volumeguid/image/0000/index")

        self.assertEqual(test.Append("foobar").SerializeToString(),
                          "http://www.google.com/foobar")

        self.assertEqual(test.Append("/foobar").SerializeToString(),
                          "http://www.google.com/foobar")

        self.assertEqual(test.Append("..").SerializeToString(),
                          "http://www.google.com/")

        self.assertEqual(test.Append("../../../..").SerializeToString(),
                          "http://www.google.com/")

        self.assertEqual(test.Append("aa/bb/../..").SerializeToString(),
                          "http://www.google.com/")

        self.assertEqual(test.Append("aa//../c").SerializeToString(),
